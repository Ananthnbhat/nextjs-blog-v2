...
1. The `useTransition` has [caveats](https://react.dev/reference/react/useTransition#starttransition-caveats).
2. The `useDeferredValue` has [caveats](https://react.dev/reference/react/useDeferredValue#caveats).
